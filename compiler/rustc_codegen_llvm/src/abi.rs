    ...
    fn store(
        ...
        if self.is_sized_indirect() {
            ...
            if can_store_through_cast_ptr {
                ...
                let cast_ptr_llty = bx.type_ptr_to_ext(cast.llvm_type(bx), bx.tcx.data_layout.default_address_space);
    ...
    fn llvm_type(&self, cx: &CodegenCx<'ll, 'tcx>) -> &'ll Type {
        ...
        let llreturn_ty = match &self.ret.mode {
            ...
            PassMode::Indirect { .. } => {
                ...
                llargument_tys.push(cx.type_ptr_to_ext(self.ret.memory_ty(cx), dl.default_address_space));
                cx.type_void()
            }
        };
