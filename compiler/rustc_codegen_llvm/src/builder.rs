...
impl<'a, 'll, 'tcx> BuilderMethods<'a, 'tcx> for Builder<'a, 'll, 'tcx> {
    ...
    fn memset(
        ...
        let ptr = self.pointercast(ptr, self.type_i8p_ext(self.tcx.data_layout.default_address_space));
        unsafe {
    ...
    fn instrprof_increment(
        ...
        let llty = self.cx.type_func(
            &[self.cx.type_i8p_ext(self.tcx.data_layout.default_address_space), self.cx.type_i64(), self.cx.type_i32(), self.cx.type_i32()],
            self.cx.type_void(),
        );
...
impl<'a, 'll, 'tcx> Builder<'a, 'll, 'tcx> {
    ...
    fn check_store(&mut self, val: &'ll Value, ptr: &'ll Value) -> &'ll Value {
        ...
        let stored_ptr_ty = self.cx.type_ptr_to_ext(stored_ty, self.tcx.data_layout.default_address_space);
    ...
    fn call_lifetime_intrinsic(&mut self, intrinsic: &str, ptr: &'ll Value, size: Size) {
        ...
        let ptr = self.pointercast(ptr, self.cx.type_i8p_ext(self.tcx.data_layout.default_address_space));
