...
impl<'a, 'tcx, V: CodegenObject> PlaceRef<'tcx, V> {
    ...
    pub fn project_field<Bx: BuilderMethods<'a, 'tcx, Value = V>>(
        ...
        let mut simple = || {
            ...
            PlaceRef {
                ...
                llval: bx.pointercast(llval, bx.cx().type_ptr_to_ext(bx.cx().backend_type(field), dl.default_address_space)),
        ...
        PlaceRef {
            // TODO: Find the correct address space here. It should be whatever llval was in.
            llval: bx.pointercast(byte_ptr, bx.cx().type_ptr_to_ext(ll_fty, dl.default_address_space)),
    ...
    pub fn project_downcast<Bx: BuilderMethods<'a, 'tcx, Value = V>>(
        ...
        downcast.llval = bx.pointercast(downcast.llval, bx.cx().type_ptr_to_ext(variant_ty, bx.tcx().data_layout.default_address_space));
            ...
            cg_base = match *elem {
                ...
                mir::ProjectionElem::Subslice { from, to, from_end } => {
                    ...
                    subslice.llval = bx.pointercast(
                        ...
                        bx.cx().type_ptr_to_ext(bx.cx().backend_type(subslice.layout), tcx.data_layout.default_address_space),
                    );
