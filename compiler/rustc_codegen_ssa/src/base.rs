    ...
    match (source.kind(), target.kind()) {
        ...
        (
            ...
            if let Some(entry_idx) = vptr_entry_idx {
                ...
                let llvtable = bx.pointercast(old_info, bx.type_ptr_to_ext(ptr_ty, dl.globals_address_space));
...
pub fn unsize_ptr<'a, 'tcx, Bx: BuilderMethods<'a, 'tcx>>(
    ...
    match (src_ty.kind(), dst_ty.kind()) {
        ...
        | (&ty::RawPtr(ty::TypeAndMut { ty: a, .. }), &ty::RawPtr(ty::TypeAndMut { ty: b, .. })) => {
            ...
            let ptr_ty = bx.cx().type_ptr_to_ext(bx.cx().backend_type(bx.cx().layout_of(b)), bx.tcx().data_layout.default_address_space);
...
pub fn maybe_create_entry_wrapper<'a, 'tcx, Bx: BuilderMethods<'a, 'tcx>>(
    ...
    fn create_entry_fn<'a, 'tcx, Bx: BuilderMethods<'a, 'tcx>>(
        ...
        let llfty = if cx.sess().target.main_needs_argc_argv {
            ...
            cx.type_func(&[cx.type_int(), cx.type_ptr_to_ext(cx.type_i8p_ext(dl.globals_address_space), dl.globals_address_space)], cx.type_int())
        } else {
        ...
        // TODO: Correct address space for i8p?
        let i8pp_ty = cx.type_ptr_to_ext(cx.type_i8p_ext(dl.globals_address_space), dl.globals_address_space);
...
fn get_argc_argv<'a, 'tcx, Bx: BuilderMethods<'a, 'tcx>>(
    ...
    if cx.sess().target.main_needs_argc_argv {
        ...
        let arg_argv = bx.const_null(cx.type_ptr_to_ext(cx.type_i8p_ext(dl.globals_address_space), dl.globals_address_space));
        (arg_argc, arg_argv)
    }
}
